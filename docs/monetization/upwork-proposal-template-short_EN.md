...
1) Examples of current names (5–20 lines are enough)
...
If you paste 5–10 current filenames and the target format, I’ll reply with a proposed mapping and the quickest path to completion.
