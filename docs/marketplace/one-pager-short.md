# Offline File Organizer - short one-pager (Upwork/Fiverr/Toptal)
...
- Generate a rename plan -> export CSV or copy CSV
...
（PowerShell 无乱码复制：`Get-Content -Raw -Encoding UTF8 .\docs\marketplace\one-pager-short.md | Set-Clipboard`）
